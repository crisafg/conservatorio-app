        ...
        <form id='form_1' action="{{ url ('conservatorio/edit/'.$alumno->id) }}" method="post" enctype="multipart/form-data" class="contents">
            <ul class="grid grid-cols-2 items-baseline">
                ...
                <!-- Lecto(escolaridades) -->                 
                    ...
                    <form id='form_2' action="{{ url ('carnet/update/'.$alumno->id) }}" method="post" enctype="multipart/form-data" class="contents">
                            @csrf
                            {{ method_field('PATCH') }}
                            ...
                            <table class="border-2">
                                ...
                                <tr>
                                    ...
                                    <td id="calificacion" class="w-2 bg-slate-50">
                                        <input oninput="if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                        class="w-full text-center" min="1" max="12" maxlength="2" type="number" name="Faltas" id="inputs" value="{{ $escolaridad->Faltas }}">
                                    </td>
                      ...
                      <div id="showInstrumento" class="hidden mt-2.5 relative right-2">
                        ...
                        @foreach ($alumno->instrumentos as $instrumento)
                            <table class="border-2">
                                ...
                                <tr>
                                    <td id="date" class="w-1/12 bg-slate-50">
                                        <input class="w-full" type="date" name="FechaInstrumento" value="{{ $instrumento->FechaInstrumento }}">
                                    </td>
                                    <td id="curso" class="bg-slate-50">
                                        <input oninput="if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                        class="w-full text-center" maxlength="1" min="1" max="6" type="number" name="CursoInstrumento" id="" value="{{ $instrumento->CursoInstrumento }}">
                                    </td>
                                    <td id="instrumento" class="w-2 bg-slate-50">
                                        <input oninput="if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                        class="w-full text-center" min="1" max="12" maxlength="2<" type="number" name="CalificacionInstrumento" id="" value="{{ $instrumento->CalificacionInstrumento }}">
                                    </td>
                                    <td id="calificacion" class="w-2 bg-slate-50">
                                        <input oninput="if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                        class="w-full text-center" min="1" max="12" maxlength="2" type="number" name="FaltasInstrumento" id="" value="{{ $instrumento->FaltasInstrumento }}">
                                    </td>
                                    <td id="observacion" class="w-64 bg-slate-50">
                                        <input class="w-full" type="text" name="ObservacionInstrumento" id="" value="{{ $instrumento->ObservacionInstrumento }}">
                                    </td>
                                </tr>
                                @endforeach
